               ...
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                         <div class="section-title">
                              <h2>Recenzie od našich klientov <small>z celého sveta</small></h2>
                         </div>
                         ...
                         <div class="owl-carousel owl-theme owl-client">
                              ...
                              <div class="col-md-4 col-sm-4">
                                   <div class="item">
                                        ...
                                        <div class="tst-author">
                                             <h4>Vladimír</h4>
                                             <span>Revízny technik</span>
                                        </div>
                                        <p>Som veľmi spokojný s prípravou na úradné skúšky na paragraf 24, kde mi boli vysvetlené najdôležitejšie veci a právne aspekty.</p>
                                        <div class="tst-rating">
                                             <i class="fa fa-star"></i>
                                             <i class="fa fa-star"></i>
                                             <i class="fa fa-star"></i>
                              ...
                              <div class="col-md-4 col-sm-4">
                                   <div class="item">
                                        ...
                                        <p>Chodím si sem obnovovať zváračský preukaz na elektródu. Tento rok som absolvoval aj kurz na tlak a plyn, čím som si výrazne rozšíril kvalifikáciu.</p>
                                        <div class="tst-rating">
                                             <i class="fa fa-star"></i>
                                             <i class="fa fa-star"></i>
                                             <i class="fa fa-star"></i>
